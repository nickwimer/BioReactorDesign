...
#H = 0.135             # height of reactor (includes D/4 with the air phase only + curved bottom)
H = 0.120             # height of reactor pre-curved bottom
Hc = 0.015            # extended distance from Z0 to curved bottom. H+Hc = overall reactor height from very bottom to top
nimpellers = 2
...
W = 0.0105   # NOT SURE estimate            # impeller blade width 
L = 0.00625   # NOT SURE estimate            # impeller blade length (beyond the hub) W=Da/5, L=Da/4
Dh =0.027 # NOT SURE            # Hub Diameter
Lin = 0.003     # NOT SURE            # impeller blade length (inside the hub)
# J =  T/50    # Baffle Width; NO BAFFLES: J=0.0017
# J = T/100
J = 0.0015
Wh = 0.002  #NOT SURE             # Hub height (Width) 
...
#mesh ========
nr  = 500 #180 #120	      # mesh points per unit radial length
nz  = 750 #360 #240             # mesh points per unit axial length
Npoly = 4            # mesh points in the polygon at the axis
Na = 4               # mesh points in the azimuthal direction
...
cb_center=[0.0,0.0,((Dt/2)**2 - (Hc)**2)/(2*Hc)]
edgep=[Dt/2,0.0,Z0]
