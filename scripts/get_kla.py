...
ofreader = pv.OpenFOAMReader(FileName = './fixed1.foam') # just need to provide folder
...
c0 = cO2[0]
params=0.5,0.1
fitparamsO2,cov=curve_fit(func, t, cO2, params)
...
np.savetxt("fitting.dat",np.transpose(np.vstack((t,cO2,cO2fit))),delimiter="  ")

np.savetxt("cstar_kla.dat",np.vstack((fitparamsO2)),delimiter="   ")
