...
int main(int argc, char *argv[])
{
    ...
    double prvs_react_update_time=floor(time/fluid_update_time.value())*fluid_update_time.value();
    double prvs_ph_update_time=floor(time/ph_update_time.value())*ph_update_time.value();
